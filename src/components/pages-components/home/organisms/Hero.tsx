        ...
        >
            ...
            <div className="relative z-[3] mx-auto flex w-full max-w-[1200px] flex-col items-center gap-10 text-center lg:flex-row lg:items-center lg:text-left">
                <div className="flex-1">
                    <span className="inline-flex items-center rounded-full border border-background/25 bg-background/10 px-3 py-1 text-[11px] sm:text-sm uppercase tracking-[0.2em]">
                    ...
                    <p className="mt-3 text-sm sm:mt-4 sm:text-lg lg:text-2xl text-background/90">
                    ...
                    <div className="mt-5 flex flex-col items-center gap-3 sm:mt-6 sm:flex-row sm:justify-center lg:justify-start">
                        <Link
                            href="/#todas-receitas"
                            className="inline-flex h-11 sm:h-12 items-center justify-center rounded-full bg-foreground px-5 sm:px-6 text-sm font-semibold text-background shadow-lg shadow-foreground/40 transition-colors hover:bg-foreground/90"
                        >
                            Explorar receitas
                        </Link>
                        <Link
                            href="/#mais-votadas"
                            className="inline-flex h-11 sm:h-12 items-center justify-center rounded-full border border-background/50 px-5 sm:px-6 text-sm font-semibold text-background transition-colors hover:bg-background/10"
                        >
                            Ver mais votadas
                        </Link>
                    </div>

                    <ul className="mt-6 hidden flex-wrap items-center justify-center gap-3 text-xs sm:flex sm:text-sm text-background/80 lg:justify-start">
                        <li className="rounded-full border border-background/20 px-3 py-1">Passo a passo claro</li>
                        <li className="rounded-full border border-background/20 px-3 py-1">Ingredientes do dia a dia</li>
                        <li className="rounded-full border border-background/20 px-3 py-1">Dicas da comunidade</li>
                    </ul>
                </div>
                ...
                <div className="flex w-full flex-1 items-center justify-center lg:justify-end">
                    <div className="relative">
                        <Image
                            ...
                            priority
                        />
                        <div className="absolute -bottom-6 left-1/2 hidden w-[85%] -translate-x-1/2 rounded-2xl border border-background/15 bg-black/40 px-4 py-3 text-left text-xs sm:block sm:text-sm backdrop-blur-md">
                            <p className="font-semibold">Receita do dia</p>
                            <p className="text-background/80">Uma combinação simples com sabor de restaurante.</p>
                        </div>
                    </div>
                </div>
            </div>
